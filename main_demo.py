...
handler.set_input_size(7)
handler.build_fully_layer(10)
handler.build_fully_layer(20)
handler.build_fully_layer(2)
# handler.build_fully_layer(1000)
# handler.build_fully_layer(1000)
handler.build_net()

handler.run_forward(netStandalone.v_float([1, 2, 3, 4, 5, 6, 7]))
...
handler.attr(netStandalone.EPOCHS, 20)\
    .attr(netStandalone.BATCH_SIZE, 1)\
...
print(handler.run_gradient("test_back", netStandalone.REUSE_FILE))
