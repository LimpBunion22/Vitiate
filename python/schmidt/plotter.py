...
COLORS = ['blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green', 'blue', 'orange', 'red', 'green']
...
def multiple_plot(x, y, args):
    ...
    ycont = 0
    color_step = 0.8/len(y)
    g = 1
    b = 0.15

    for ylst in y:
        color = ((1,g,b,1))#COLORS[ycont]
        g -= color_step
        b += color_step
