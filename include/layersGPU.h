...
namespace gpu
{
    ...
    private:
        ...
        float *_fx_data;
        float *_fx_accum;
        size_t _stream_index;
        stream_pack *_streams;
        cublas_data *_cublas;
        float *_batch_multiplier;
    ...
    private:
        ...
        // methods
        void _free_mem();
        void _advance_stream();
        cudaStream_t _get_active_stream();

        fully_layer() = delete;
        fully_layer(cublas_data &cublas, stream_pack &streams);
    ...
    public:
        ...
        virtual void run_layer_forward_async() = 0;
    ...
    {
    public:
        hidden_fully_layer() = delete;
        hidden_fully_layer(cublas_data &cublas, stream_pack &streams);
        ...
        void run_layer_forward_async() override;
    ...
    private:
        ...
        size_t _evt_index;
        cub_data *_cub;
        std::vector<cudaEvent_t> _evts; // we sync last layer if we use softmax so we can use only one cub_data (doesnt affect performance)

    private:
        void _free_mem();
        void _advance_evt();
        cudaEvent_t _get_active_evt();
        cudaEvent_t _get_prev_evt();

    public:
        out_fully_layer() = delete;
        out_fully_layer(cub_data &cub, cublas_data &cublas, stream_pack &streams);
    ...
    public:
        ...
        in_fully_layer(int input_size, cublas_data &cublas, stream_pack &streams);
